...
export class Character implements IInputReceiver{
    ...
    public handleKeyboardEvent(event: KeyboardEvent, code: string, pressed: boolean): void{
		...
		{
            this.world.inputManager.setInputReceiver(this.world.inputManager.freeCamReceiver);
            if(this.world.inputManager.inputReceiver != undefined){
                this.world.inputManager.inputReceiver.lastInputManager = this;
                this.world.inputManager.freeCamReceiver.target = this.camera.position.clone();
            }
		}
		else
		{
    ...
    public update(timeScale: number): void
        {   
            this.target = this.world.playerManager.players[this.world.player_id].get_position()
